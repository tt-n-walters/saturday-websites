...
// 	}
// }
let born1600s = inventors.filter(function (inventor) {
	return inventor.year > 1600 && inventor.year < 1700
})
console.table(born1600s)


let inventorAges = inventors.map(function (inventor) {
	return {
...
let ages1875sorted = ages1875.sort(function (first, second) {
